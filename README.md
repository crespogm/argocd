...
# Clone Repository
Clone crespogm/argocd repository to your local device.
```
git clone https://github.com/crespogm/argocd.git
```
...
server:
  ...
  config:
    repositories: |
      - type: git
        url: https://github.com/crespogm/argocd.git
      - name: argo-helm
        type: helm
  ...
  additionalApplications: 
    - name: argocd
      ...
      source:
        ...
        repoURL: https://github.com/crespogm/argocd.git
        targetRevision: HEAD
      syncPolicy:
        syncOptions:
